...
| [app.md](app.md) | `app/` | `@grantfox/app` — Vite + React 19 wallet frontend: passkey smart-account onboarding, privacy bundle (CT keys + SPP root secret) + encrypted backup, and the Confidential Token rail (register/deposit/merge/send/withdraw, in-browser UltraHonk proving, activity feed) |
