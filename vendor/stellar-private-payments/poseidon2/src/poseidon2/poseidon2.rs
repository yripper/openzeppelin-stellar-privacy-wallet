...
mod poseidon2_tests_goldilocks {
    ...
    use crate::{
        ...
        poseidon2::poseidon2_instance_goldilocks::{
...
mod poseidon2_tests_babybear {
    ...
    use crate::{
        ...
        poseidon2::poseidon2_instance_babybear::{
...
mod poseidon2_tests_bls12 {
    ...
    use crate::{
        ...
        poseidon2::poseidon2_instance_bls12::{
...
mod poseidon2_tests_bn256 {
    ...
    use crate::{
        ...
        poseidon2::poseidon2_instance_bn256::POSEIDON2_BN256_PARAMS_3,
    };
    use std::convert::TryFrom;
...
mod poseidon2_tests_pallas {
    ...
    use crate::{
        ...
        poseidon2::poseidon2_instance_pallas::{
