...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_9201: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9203: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1256: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_5139: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_6450: (a: number, b: number) => void;
