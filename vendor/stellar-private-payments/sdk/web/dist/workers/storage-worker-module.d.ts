...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_938: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4348: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_663: (a: number, b: number) => void;
